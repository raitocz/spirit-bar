...
- Automatický překlad akcí do všech jazyků (en/de/pl/sigma) přes Claude Haiku při vytvoření/úpravě
- Kompletní lokalizace veřejné stránky akcí (data, měsíce, UI texty, tagy)
