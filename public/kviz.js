...
(function () {
  ...
  function renderForm(q) {
    var animals = [
      "\u{1F42D}", "\u{1F98A}", "\u{1F43C}", "\u{1F42E}", "\u{1F437}", "\u{1F438}", "\u{1F435}", "\u{1F413}",
      "\u{1F984}", "\u{1F4A9}", "\u{1F47D}", "\u{1F638}", "\u{1F608}", "\u{1F476}\u{1F3FF}", "\u{1F986}",
      "\u{1F965}", "\u{1F346}", "\u{1F351}", "\u{26BD}", "\u{1F451}", "\u{1F5FF}", "\u{267B}\u{FE0F}"
    ];
